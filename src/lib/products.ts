...
export const products: Product[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Flexible 21 to 45 day repayment intervals",
  ...
  },
  {
    ...
    short: "Small Business Asset & Motorcycle Loan",
    category: "Graduation Loan • Asset Finance",
    featured: true,
    isStarterProduct: false,
    graduationTier: "Level 3: Asset & Scale",
    targetAsset: "Motorcycles (boda boda / courier), machinery, tools, and commercial equipment",
    graduationNotice:
      "Graduation Product: Unlocked for trusted business owners ready to acquire revenue-generating equipment, delivery motorcycles, or machinery.",
    headline: "Invest in machines, motorcycles, and tools that multiply your daily profit.",
    summary:
      "Empowering small businesses and independent operators to own productive assets. Finance delivery motorcycles (boda boda), commercial refrigeration, posho mill motors, tailoring machinery, or salon gear from KES 10,000 to 150,000 with 1 to 12 months to pay.",
    min: 10000,
    max: 150000,
    tenure: "1 – 12 months",
    tenureShort: "1–12 mo",
    ...
    accent: "navy",
    bestFor: [
      "Boda boda operators & courier delivery riders",
      "Carpenters, metal fabricators & workshop owners",
      "Butcheries & grocers needing commercial chillers",
      "Tailoring & garment businesses acquiring industrial machines",
    ],
    uses: [
      "New or certified delivery motorcycles (boda boda)",
      "Commercial deep freezers & milk coolers",
      "Welding sets, generators & workshop tools",
      "Industrial sewing machines & salon workstations",
      "Posho mill electric motors & spare parts",
    ],
    features: [
