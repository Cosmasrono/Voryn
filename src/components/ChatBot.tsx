  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Habari! 👋 I'm **Vori**, your Voryn Capital assistant. I can help you find the right loan, explain eligibility, or guide you through applying. How can I help?",
    },
  ]);
